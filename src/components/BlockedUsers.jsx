...
const BlockedUsers = () => {
  ...
  return (
    <div>
      <div className='bg-white w-[25dvw] h-[48dvh] flex flex-col rounded-xl border-gray-200 shadow-xl overflow-hidden mt-7'>
        <div className='flex'>
          <p className='ml-6 mt-2 font-semibold '>Blocked Users</p>
          <span className='mt-3 ml-50 text-secondary_color font-bold text-[22px]' ><FaEllipsisVertical /></span>
