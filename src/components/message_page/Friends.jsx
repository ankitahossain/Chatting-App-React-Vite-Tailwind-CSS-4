...
const Friends = () => {
  ...
  return (
    <div>
      <div className='bg-white w-[30dvw] h-[48dvh] flex flex-col rounded-xl border-gray-200 shadow-xl overflow-hidden mt-7'>
        <div className='flex'>
          <p className='ml-6 mt-2 font-semibold '>Friends</p>
